<?php
if($_POST && !empty($_POST['username']) && !empty($_POST['password']) && isset($_POST['key']) && $_POST['key'] == '3TcXN9rR2vxk8qj38388tujDTRJX2C3s9M3Cug') {
	try
	{
	...
	$req = $bdd_server->prepare('UPDATE joueurs SET user_mdp=:user_mdp WHERE user_pseudo=:user_pseudo');
